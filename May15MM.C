...
double widening = (double)1.0/2.25; // 1.0/2.25 makes sig between -1.33.. and 1.33.. // if want to turn off, make it 0
...
{	
	...
	cout << endl << endl << "using widening = 1.0/2.25 so sig is from -1.33... to 1.33..." << endl;
