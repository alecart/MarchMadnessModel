...
{	
	...
	for (int i = 0; i < 1000; i++)
	{
		...
		*/
		...
		cout << "16 seed Elite 8 wins: " << bracketTWO__sixteen << endl << endl << endl;
		*/
	...
	//
		...
		cout << "16 seed Elite 8 wins: " << bracketTHREE__sixteen << endl << endl << endl;
		*/
	...
	cout << endl << endl << "using > chance" << endl;
}
