...
double widening = (double)1.0/3.5; // 1.0/4.0 makes sig between -0.857 and 0.857 // if want to turn off, make it 0
...
{	
	...
	cout << endl << endl << "using widening = 1.0/3.5 so sig is from -0.857 to 0.857" << endl;
}
