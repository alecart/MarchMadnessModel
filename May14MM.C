...
double widening = (double)1.0/2.5; // 1.0/2.5 makes sig between -1.2 and 1.2 // if want to turn off, make it 0
...
{	
	...
	cout << endl << endl << "using widening = 1.0/2.5 so sig is from -1.2 to 1.2" << endl;
