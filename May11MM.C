...
double widening = (double)1.0/6.0; // 1.0/6.0 makes sig between -0.5 and 0.5 // if want to turn off, make it 0
...
int main() 
{
	...
	for (int i = 0; i < 1; i++)
	{
		...
		cout << "16 seed Elite 8 wins: " << bracketONE__sixteen << endl;
	...
	//
		...
		Championship();
				...
				// TALLYING THE SWEET 16 WINS
		if (championship_advancing[0] == 0) 
			final4_one++;
		
		if (championship_advancing[0] == 15)
			final4_sixteen++;
		
		if (championship_advancing[0] == 7)
			final4_eight++;
		
		if (championship_advancing[0] == 8)
			final4_nine++;
		
		if (championship_advancing[0] == 4)
			final4_five++;
		
		if (championship_advancing[0] == 11)
			final4_twelve++;
		
		if (championship_advancing[0] == 3)
			final4_four++;
		
		if (championship_advancing[0] == 12)
			final4_thirteen++;
		
		if (championship_advancing[1] == 10)
			final4_eleven++;
			
		if (championship_advancing[1] == 2)
			final4_three++;
			
		if (championship_advancing[1] == 13)
			final4_fourteen++;
			
		if (championship_advancing[1] == 6)
			final4_seven++;
			
		if (championship_advancing[1] == 9)
			final4_ten++;
			
		if (championship_advancing[1] == 1)
			final4_two++;
			
		if (championship_advancing[1] == 14)
			final4_fifteen++;
		
		if (championship_advancing[1] == 5)
			final4_six++;
