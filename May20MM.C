...
double widening = (double)0.0/3.0; // 1.0/3.0 makes sig between -1 and 1 // if want to turn off, make it 0
...
{	
	...
	cout << endl << endl << "using widening = 0.0/3.0 so sig is from 0 to 0" << endl;
